...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card" className={cn('bg-card text-card-foreground flex flex-col gap-6 rounded-[10px] border py-5 shadow-[0_0_12px_0_rgba(0,0,0,0.06)]', className)} {...props} />;
}
